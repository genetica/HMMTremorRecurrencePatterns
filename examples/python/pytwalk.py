...
class pytwalk:
    ...
    def setup( self, x0, xp0, t=1):
        T = 1
        self.t = t

        sec = time()
        print("pytwalk: Started")
    ...
    def  step( self, x, u, xp, up):
        ...
        Output[0:self.n] = x.copy()
        Output[self.n] = u   

        self.Output = np.vstack((self.Output, Output))  
